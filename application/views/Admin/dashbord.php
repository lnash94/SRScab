...
<nav class="navbar " style="background-color: aliceblue; ">
  <ul class="nav navbar-nav userdashbord"  >
   <li><a href="<?php echo base_url();?>users/admindashbord" style="color: black;" >Manage Vehicles</a>
    <li><a  href="<?php echo base_url();?>users/admindashbord/addvehicle" style="color: black;" >New Vehicle</a></li>
    
    <li><a href="<?php echo base_url();?>users/admindashbord/newpromotion" style="color: black;">New Promotion</a></li>
