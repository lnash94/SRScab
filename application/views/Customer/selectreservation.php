...
<div class="container col-md-10" style="background-color: white;">	
	...
	foreach($vehicles as  $vehicle){
		 echo "<div class=\"gallery_product well col-lg-6 col-md-12 col-sm-6 col-xs-6 filter ".$vehicle['type']."\" id=\"".$vehicle['L_No']."\" name=\"".$vehicle['brand']."\">
			...
			<div class="col-md-1" style="padding-top: 55px; padding-left: 0px;">
				<button class="btn btn-success btn-sm" id="book" onclick="reserve(this);" value="<?php echo $vehicle['L_No'] ?>" style="width: 60px;">Book</button>
			</div>
